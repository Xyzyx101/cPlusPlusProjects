...
string mixUp(string* aWord); // returns a jumbled word
void welcomePlayer(const string* const aJumble);
void play(const string* const aWord);
...
void welcomePlayer(const string* const aWord)
{
